...
import controller.ServiceLogPopUpController;
...
public class ServiceLogPopUpView extends JFrame {
    ...
    public ServiceLogPopUpView(String name, ServiceLog selectedServiceLog, OperationsView<ServiceLog> serviceLogOperationsView, UserInterface employeeInterface) {
        super(name);
        this.selectedServiceLog = selectedServiceLog;
        this.serviceLogPopUpController = ServiceLogPopUpController.getControllerInterface(serviceLogOperationsView, employeeInterface, this);
