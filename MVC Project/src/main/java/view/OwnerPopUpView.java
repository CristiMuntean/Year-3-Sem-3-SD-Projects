...
import model.Owner;
import controller.OwnerPopUpController;
...
public class OwnerPopUpView extends JFrame {
    ...
    OwnerPopUpController ownerPopUpController;

    public OwnerPopUpView(String name, Owner selectedOwner, OperationsView<Owner> ownerOperationsView) {
        super(name);
        this.selectedOwner = selectedOwner;
        ownerPopUpController =  OwnerPopUpController.getControllerInstance(ownerOperationsView, this);
