...
public class ManagerVM extends AbstractEmployeeVM {
    ...
    private final CommandInterface searchCommand;
    ...
    private ManagerVM() {
        ...
        searchCommand = new SearchCarsCommand(this);
    ...
    public static ManagerVM getManagerVMInstance() {
        if (instance == null)
            instance = new ManagerVM();
        return instance;
    }
    ...
    public CommandInterface getSearchCommand() {
