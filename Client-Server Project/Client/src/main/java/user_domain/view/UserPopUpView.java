...
import user_domain.controller.UserPopUpController;
...
public class UserPopUpView extends JFrame {
    ...
    public UserPopUpView(String name, User selectedUser, OperationsView<User> userOperationsView, UserInterface employeeInterface, ProxyClient client) {
        super(name);
        this.selectedUser = selectedUser;
        this.userPopUpController = UserPopUpController.getControllerInterface(userOperationsView, employeeInterface, this, client);
