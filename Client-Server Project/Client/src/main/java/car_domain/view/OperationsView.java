...
import car_domain.controller.OperationsController;
...
public class OperationsView<T> extends JFrame implements OperationsInterface<T>, Observer {
    ...
    public OperationsView(String name, Class operationClass, UserInterface userInterface, ProxyClient client) {
        super(name);
        this.operationClass = operationClass;
        operationsController = new OperationsController<T>(operationClass, this, client);
